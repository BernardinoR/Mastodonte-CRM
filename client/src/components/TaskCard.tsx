      ...
      <ContextMenu>
        <ContextMenuTrigger asChild>
          ...
          <CardContent className={cn("space-y-2", isCompact && !isEditing ? "p-3 md:p-3" : "p-3 md:p-4 pt-0")}>
              ...
              <div className="flex items-center text-[8px] md:text-[10px] font-semibold text-foreground">
                <TaskDatePopover
                  id={id}
              ...
              <div className={cn("space-y-1.5", isEditing && "-mx-2")}>
                <div className={cn("text-[8px] md:text-[10px] font-semibold text-muted-foreground uppercase tracking-wider", isEditing && "px-2")}>
                  Responsáveis
                </div>
