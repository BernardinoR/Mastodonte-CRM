  ...
  return (
    <div className="p-6">
      ...
      <div className="flex gap-6 overflow-x-auto pb-4">
        <KanbanColumn title="To Do" count={todoTasks.length} color="text-blue-400">
          {todoTasks.map(task => (
            <TaskCard
              key={task.id}
              {...task}
        ...
        <KanbanColumn title="In Progress" count={inProgressTasks.length} color="text-primary">
        ...
        <KanbanColumn title="Done" count={doneTasks.length} color="text-green-400">
          {doneTasks.map(task => (
            <TaskCard
              key={task.id}
              {...task}
