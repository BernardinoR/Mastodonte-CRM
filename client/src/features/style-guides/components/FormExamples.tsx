    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm">Slider</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm">RadioGroup</CardTitle>
        </CardHeader>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm">ToggleGroup</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm">InputOTP</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
