...
export const DISABLED_SECTIONS_TOP: DisabledSectionConfig[] = [
  {
    ...
    title: "Farol",
    icon: AlertCircle,
    description: "Indicador de acompanhamento do cliente",
  },
  {
    id: "guidance",
    title: "Guidance",
    icon: Lightbulb,
    description: "Orientações para próxima reunião",
  },
];
...
export const DISABLED_SECTIONS_BOTTOM: DisabledSectionConfig[] = [
  ...
  {
    id: "erros",
    title: "Erros e Ocorrências",
    icon: AlertTriangle,
    description: "Registro de erros e ocorrências",
  },
  {
    id: "pipeline",
    title: "Pipeline de Indicações",
    icon: GitBranch,
