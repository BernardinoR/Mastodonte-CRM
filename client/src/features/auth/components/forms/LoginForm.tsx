...
export function LoginForm({
  ...
  return (
    <>
      <h2 className="mb-2 text-2xl font-semibold text-white">Bem-vindo de volta</h2>
      <p className="mb-6 text-sm text-[#888]">Insira seus dados para acessar o painel.</p>
      ...
      <div className="my-6 flex items-center text-xs uppercase tracking-wider text-[#555]">
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="mb-4">
          <label className="mb-1.5 block text-xs font-medium text-[#888]">Senha</label>
          <input
            type="password"
            className="input-dark"
            placeholder="••••••••"
