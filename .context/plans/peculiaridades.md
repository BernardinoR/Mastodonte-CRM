...
# Seção Peculiaridades no Detalhe do Cliente Plan

> Adicionar seção Peculiaridades na página de detalhe do cliente com lista de textos, toggle para desligar reunião mensal, e integração com banco de dados via Supabase
